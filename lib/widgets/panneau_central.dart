    ...
    child: FutureBuilder(
      ...
      builder: (context, asyncSnapshot) {
        ...
        if(asyncSnapshot.hasData){
          ...
          return Center(
            child: Text("Erreur: une erreur s'est produite lors du chargement", style: GoogleFonts.inter(color: const Color.fromARGB(255, 216, 130, 124),fontSize: 24),
            ),
          );
        }else{
          return Center(
